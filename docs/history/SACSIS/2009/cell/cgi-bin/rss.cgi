...
foreach $key (reverse sort keys %CONTENTS ){
...
<channel>
 <title>Cell Challenge 2009</title>
 <link>${BASEURL}</link>
 <description>Web Page for Cell Challenge 2009</description>
 <copyright>Cell Challenge 2009 Committee</copyright>
